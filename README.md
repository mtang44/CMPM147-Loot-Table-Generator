...
To import a custom loot table, open the provided Loot Table .csv file. In the .csv file, you will find a spreadsheet that allows you to fill out custom loot attributes. Loot Rarities, Item Names, Item Type, and Item Description can all be filled in just using the spreadsheet. The .csv file should already be attached to the loot chest, but in the event it is not, copy the path of the file from the Unity folder and paste that into the "Loot Table File Path" input field in the Chest Inspector
...
<img width="700" height="633" alt="image" src="https://github.com/user-attachments/assets/53f2ae56-c1ee-4555-937a-bbc557411c6d" />
...
<img width="700" height="633" alt="image" src="https://github.com/user-attachments/assets/09a73300-e028-434d-ba9b-d1a5e4380300" />



## **Example Outputs**
<img width="400" height="400" alt="image" src="https://github.com/user-attachments/assets/a78c8e37-44be-40ba-a31b-589154a240eb" />

<img width="310" height="400" alt="image" src="https://github.com/user-attachments/assets/79751c5d-8db8-44f0-8e4b-bc73d1b1c590" />

## **Limitations:**

- When placing multiple chests around a map, it is up to the user of this tool to figure out which chest is being accessed. To open a chest, call the chest's Open() function. This will 
...
- The Loot chest does not accommodate changes to the format of additional item categories in the .csv file. Any addition of new item stat categories will also need to be manually adjusted within insertCustomLootTable(). 
